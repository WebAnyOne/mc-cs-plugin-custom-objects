...
final class ContactSubscriberTest extends MauticMysqlTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->contactMerger                   = static::getContainer()->get('mautic.lead.merger');
        $this->customItemXrefContactRepository = static::getContainer()->get('custom_item.xref.contact.repository');
    }
